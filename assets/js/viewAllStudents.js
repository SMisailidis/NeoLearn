  ...
  const renderContent = () => {
    pagination.renderContent(() => {
      ...
      $.each(pageData, function (index, row) {
        ...
        let expandedDeleteUser = $("<button>").addClass("btn btn-outline-danger").append(iconTrash).append($("<p>").append($("<span>").text("Delete")).append($("<span>").text("User"))).on("click", onDeleteHandler)
        let expandedUpdateUser = $("<button>").addClass("btn btn-outline-success").append(iconUpdate).append($("<p>").append($("<span>").text("Update")).append($("<span>").text("User"))).on("click", onUpdateHandler)
        let expandedLink = $("<article>").addClass("profileHref").append(
